        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center space-x-8">
                    ...
                    <a href="{{ route('sites.index') }}" class="text-gray-600 hover:text-gray-900 text-sm">サイト</a>
                    <a href="{{ route('design.tokens') }}" class="text-gray-600 hover:text-gray-900 text-sm">デザイン</a>
                    <a href="{{ route('design.components') }}" class="text-gray-600 hover:text-gray-900 text-sm">コンポーネント</a>
                </div>
