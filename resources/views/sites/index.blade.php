...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <table class="w-full">
        <thead class="bg-gray-50">
            <tr>
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Clinic ID</th>
        ...
        <tbody class="divide-y divide-gray-200">
            @forelse($sites as $site)
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4 text-sm text-gray-500 font-mono">{{ $site->clinic_id }}</td>
                    ...
                    <td class="px-6 py-4 text-right space-x-2">
                        ...
                        <a href="{{ route('sites.edit', $site) }}" class="text-gray-500 hover:underline text-sm">編集</a>
                    </td>
                </tr>
            @empty
                <tr>
                    <td colspan="6" class="px-6 py-8 text-center text-gray-500">まだサイトがありません</td>
                </tr>
            @endforelse
        </tbody>
    </table>
